...
key = '268fdf16-9e8c-49b9-9efb-a7cae86db1a4;IngestionEndpoint=https://westus2-2.in.applicationinsights.azure.com/'
...
# Metrics
exporter = metrics_exporter.new_metrics_exporter(enable_standard_metrics=True,connection_string=f'InstrumentationKey={key}')
...
# Requests
middleware = FlaskMiddleware(app,exporter=AzureExporter(connection_string=f'InstrumentationKey={key}'),sampler=ProbabilitySampler(rate=1.0))
...
def index():
    ...
    if request.method == 'GET':
        ...
        tracer.span(name='VotedCat')
        vote2 = r.get(button2).decode('utf-8')
        tracer.span(name='VotedDog')
